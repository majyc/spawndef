...
public class PosTest {
	...
	public void moveNorth() {
		...
		Pos p2 = new Pos(p);
		p.move(COORD.Y, -10);
		String expected = "Pos 133.326782 158.000000 -646.427490";
		assertEquals(expected, p.toString());
		p2.moveDirection(COMPASS.NORTH, 10);
		String expected2 = "Pos 133.326782 158.000000 -646.427490";
	...
	public void moveSouth() {
		...
		Pos p2 = new Pos(p);
		p.move(COORD.Y, 10);
		String expected = "Pos 133.326782 178.000000 -646.427490";
		assertEquals(expected, p.toString());
	...
	public void moveWest() {
		...
		Pos p2 = new Pos(p);
		p.move(COORD.X, 10);
		String expected = "Pos 143.326782 168.000000 -646.427490";
		assertEquals(expected, p.toString());
	...
	public void moveEast() {
		...
		Pos p2 = new Pos(p);
		p.move(COORD.X, -10);
		String expected = "Pos 123.326782 168.000000 -646.427490";
		assertEquals(expected, p.toString());
	...
	public void moveNorthEast() {
		Pos original = new Pos("133.326782", "168.000000", "-646.427490");
		...
		String expected =  "Pos 126.255714 160.928932 -646.427490";
